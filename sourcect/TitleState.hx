...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			// credTextShit.screenCenter();
			case 13:
				addMoreText('VS Five Hundo');
			// credTextShit.visible = true;
			case 14:
				addMoreText('GD in FNF');
			// credTextShit.text += '\nNight';
			case 15:
				addMoreText('Robtop Finish dos point dos'); // credTextShit.text += '\nFunkin';
			case 16:
				skipIntro();
		}
	}
